...
class TestCleanTrace(unittest.TestCase):
    ...
    def test_clean_llseek(self):
        lines = [
                 "0 940 940 (tar) generic_file_llseek 1319227140807676-6 (/ /home/ourgrid/vserver_images/worker.lsd.ufcg.edu.br_2/ /home/etc/group/ 1006 S_IFREG|S_IROTH|S_IRGRP|S_IWUSR|S_IRUSR 384707) 0 SEEK_CUR 0",
                 "0 916 916 (rm) generic_file_llseek 1319227065620757-4 (/ /home/ourgrid/worker_N2/ /home/ourgrid/vserver_images/worker.lsd.ufcg.edu.br_2/usr/lib/R/library/datasets/R-ex/ 4096  2482247) 0 SEEK_SET 0"
                ]
