...
#define NFSD_PROC_FSSTAT_OP (LSETXATTR_OP + 1)
#define NFSD_PROC_SETATTR_OP (NFSD_PROC_FSSTAT_OP + 1)
#define NFSD_PROC_GETATTR_OP (NFSD_PROC_SETATTR_OP + 1)
#define NFSD_PROC_LOOKUP_OP (NFSD_PROC_GETATTR_OP + 1)
#define NFSD_PROC_WRITE_OP (NFSD_PROC_LOOKUP_OP + 1)
#define NFSD_PROC_READ_OP (NFSD_PROC_WRITE_OP + 1)
#define NFSD_PROC_RENAME_OP (NFSD_PROC_READ_OP + 1)
#define NFSD_PROC_REMOVE_OP (NFSD_PROC_RENAME_OP + 1)
#define NFSD_PROC_RMDIR_OP (NFSD_PROC_REMOVE_OP + 1)
#define NFSD_PROC_LINK_OP (NFSD_PROC_RMDIR_OP + 1)
#define NFSD_PROC_SYMLINK_OP (NFSD_PROC_LINK_OP + 1)
#define NFSD_PROC_READLINK_OP (NFSD_PROC_SYMLINK_OP + 1)
#define NFSD_PROC_READDIR_OP (NFSD_PROC_READLINK_OP + 1)
#define NFSD_PROC_READDIRPLUS_OP (NFSD_PROC_READDIR_OP + 1)
